...
def make_location():
    ...
    def _make(**overrides) -> NormalizedLocation:
        defaults = dict(
            ...
            lat=42.3588,
            lon=-71.0707,
            address=Address(street="74 Joy St", city="Boston", state="MA", postcode="02114"),
            contact=Contact(phone="617-555-0101", website="https://example.com"),
            services=[Service(activity=Activity.REPAIR_FREE, item_category=ItemCategory.ELECTRONICS)],
